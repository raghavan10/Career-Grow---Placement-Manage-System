...
public class ProxyStudent {
	...
	public ProxyStudent(Integer id, String name, String college, String rollno, String qualification, String course,
			Integer year, String certificate, Integer hallticketno, Integer certificate_Id, Integer college_id,
			Boolean is_update) {
		super();
		this.id = id;
		this.name = name;
